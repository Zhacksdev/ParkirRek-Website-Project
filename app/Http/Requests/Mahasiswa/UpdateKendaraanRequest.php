...
class UpdateKendaraanRequest extends FormRequest
{
    ...
    {
        // Ambil id kendaraan dari route (bisa int atau model)
        $routeParam = $this->route('kendaraan');
        $kendaraanId = is_object($routeParam) ? ($routeParam->id ?? null) : $routeParam;
        ...
        return [
            ...
            'plat_no' => [
                ...
                'string',
                'max:20',
                Rule::unique('kendaraans', 'plat_no')->ignore($kendaraanId),
            ],
